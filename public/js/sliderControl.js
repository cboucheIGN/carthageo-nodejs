L.Control.SliderControl = L.Control.extend({
    ...
    extractTimestamp: function(time, options) {
        ...
        console.log(time.toString().substr(options.startTimeIdx, options.startTimeIdx + options.timeStrLength));
                ...
                if(!!_options.markers[ui.value]) {
                    ...
                    if(_options.markers[ui.value].feature !== undefined) {
                        ...
                        if(_options.markers [ui.value].options[_options.timeAttribute]){
                            if(_options.markers[ui.value]) $('#slider-timestamp').html(_options.markers[ui.value].options.startDate.toString().substr(0, 19));
                        }else {
                            console.error("Time property "+ _options.timeAttribute +" not found in data");
                        }
                    }
